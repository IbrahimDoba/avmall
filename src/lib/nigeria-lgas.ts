 ...
 * Source: INEC official LGA listing. Used in address forms and shipping zone config.
 * Phase 6 will migrate this to the `nigeria_states_lgas.json` seed file per CLAUDE.md §22.
 */

export const NIGERIA_LGAS: Record<string, readonly string[]> = {
  Abia: [
    "Aba North", "Aba South", "Arochukwu", "Bende", "Ikwuano",
    "Isiala Ngwa North", "Isiala Ngwa South", "Isuikwuato", "Obi Ngwa", "Ohafia",
    "Osisioma", "Ugwunagbo", "Ukwa East", "Ukwa West",
  ...
  Benue: [
    ...
    "Obi", "Ogbadibo", "Ohimini", "Oju", "Okpokwu", "Otukpo",
  ...
  Delta: [
    ...
    "Warri Central", "Warri North", "Warri South",
  ],
  Ebonyi: [
  ...
  Jigawa: [
    "Auyo", "Babura", "Birnin Kudu", "Birniwa", "Buji", "Dutse",
